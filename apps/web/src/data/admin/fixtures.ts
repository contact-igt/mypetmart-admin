...
export const CATEGORIES: Category[] = [
  { id: "cat-grooming", name: "Grooming", slug: "grooming", order: 0, active: true },
  { id: "cat-walking", name: "Walking Essentials", slug: "walking-essentials", order: 1, active: true },
  { id: "cat-paw-care", name: "Paw Care", slug: "paw-care", order: 2, active: true },
  { id: "cat-dog", name: "Dog Essentials", slug: "dog-essentials", order: 3, active: true },
  { id: "cat-cat", name: "Cat Essentials", slug: "cat-essentials", order: 4, active: true },
  { id: "cat-seasonal", name: "Seasonal", slug: "seasonal", order: 5, active: false },
];
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 399,
    stock: 0,
    imageLabel: "Dog collar with reflective stitching on a dark background",
    tone: "brown",
  ...
  },
  {
    ...
    originalPrice: 2799,
    stock: 11,
    imageLabel: "Tall cat scratching post in a sunlit room",
    tone: "mint",
  ...
  },
  {
    ...
    originalPrice: 999,
    stock: 5,
    imageLabel: "Stack of puppy training pads",
    tone: "cream",
  ...
  },
  {
    ...
    originalPrice: 399,
    stock: 33,
    imageLabel: "Double-sided grooming comb on a wooden surface",
    tone: "orange",
  ...
  },
  {
    ...
    price: 1899,
    stock: 0,
    imageLabel: "Cat water fountain on a kitchen counter",
    tone: "mint",
  ...
  },
  {
    ...
    originalPrice: 799,
    stock: 27,
    imageLabel: "Fleece blanket folded on a dog bed",
    tone: "peach",
